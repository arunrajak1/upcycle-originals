                    ...
                    <Link  to={`/categories/${card}`} className="p-4 md:w-1/3 cursor-pointer">
                        <div className="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
                            <div className="flex items-center mb-3">
                                ...
                                <h2 className="text-gray-900 text-lg title-font font-medium capitalize">SELL YOUR PLASTIC WASTE</h2>
                            </div>
                    ...
                    <Link   to={`/categories/${card}`}className="p-4 md:w-1/3 cursor-pointer">
                        <div className="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
                            <div className="flex items-center mb-3">
                                ...
                                <h2 className="text-gray-900 text-lg title-font font-medium capitalize">BUY UPCYCLED PRODUCTS</h2>
                            </div>
                            <div className="flex-grow">
                                <p className="leading-relaxed text-base ">Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy. Gastropub indxgo juice poutine.</p>
                                <a className="mt-3 text-green-500 inline-flex items-center">Learn More
                    ...
                    <Link  to={`/categories/${card}`} className="p-4 md:w-1/3 cursor-pointer">
                        <div className="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
                            <div className="flex items-center mb-3">
                                ...
                                <h2 className="text-gray-900 text-lg title-font font-medium capitalize">JOIN US FOR CLEANING EVENTS</h2>
                            </div>
                            <div className="flex-grow">
                                <p className="leading-relaxed text-base ">Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy. Gastropub indxgo juice poutine.</p>
                                <a className="mt-3 text-green-500 inline-flex items-center">Learn More
